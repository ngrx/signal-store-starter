...
@Component({
  selector: 'app-delete-internal',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterLink],
  templateUrl: './delete-internal.component.html',
  styleUrls: ['./delete-internal.component.scss']
})
export class DeleteInternalComponent {
  ...
  constructor() {
    ...
    effect(() => {
      if (this.store.error && this.store.error()) {
        console.error('Internal delete error:', this.store.error());
      }
  ...
  onSubmit(): void {
    if (this.deleteForm.valid) {
      // TODO: Implement delete Internal logic
      console.log('delete Internal:', this.deleteForm.value);
    }
  }
