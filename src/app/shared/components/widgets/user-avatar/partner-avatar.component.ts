  ...
  template: `
    <div class="user-section">
      <div class="avatar-container" (click)="toggleMenu()">
        <div class="avatar-icon-partner">
          <span class="partner-icon">🤝</span>
        </div>
        <span class="context-name">{{ partnerName() }}</span>
      ...
      @if (menuOpen()) {
        <div class="dropdown-menu" (click)="$event.stopPropagation()">
          <div class="menu-header">
            <div class="menu-partner-icon">🤝</div>
            <div class="menu-user-info">
              <div class="menu-email">{{ partnerName() }}</div>
              <div class="menu-status">Partner Context</div>
            </div>
          </div>

          @for (section of partnerMenu().sections; track section.id) {
...
export class PartnerAvatarComponent {
  ...
  // Computed signals
  protected partnerName = computed(() => {
    return this.contextStore.currentContextName() || 'Partner';
  });

  protected partnerMenu = computed(() => {
    // Build partner-specific menu
    return {
      sections: [
        {
          id: 'partner-actions',
          ...
          items: [
            ...
            },
            {
              ...
              icon: '📁',
              route: '/partner/workspaces',
              visible: true,
            },
            {
              id: 'collaboration',
              type: 'link' as const,
              label: 'Collaboration Stats',
              icon: '📊',
              route: '/partner/stats',
              visible: true,
            },
